...
```{r}
library("vsn")
pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\sdplot_shiftedLogtransformed.pdf")
meanSdPlot(assay(ntd))
dev.off()

pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\sdplot_regLogtransformed.pdf")
meanSdPlot(assay(rld))
dev.off()

pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\sdplot_varstabilizedtransformed.pdf")
...
```{r}
pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\allsamples_genotype_PCA.pdf")
sampleDists <- dist(t(assay(vst)))
plotPCA(rld, intgroup=c("genotype"))
dev.off()

pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\allsamples_treatment_PCA.pdf")
sampleDists <- dist(t(assay(vst)))
plotPCA(rld, intgroup=c("housing"))
dev.off()

pdf("C:\\GitHub\\dnFGFR\\deseq_outputs\\allsamples_day_PCA.pdf")
sampleDists <- dist(t(assay(vst)))
